    ...
    var PisteTableHome = {
        oData: {
            ...
            aColumns: [
              ...
              {id: "Piani-tbPiani-col5", order: 3, text: oResource.getText("SISTEMA"), visible: true},
              {id: "Piani-tbPiani-col8", order: 4, text: oResource.getText("CLASSE"), visible: true},
              {id: "Piani-tbPiani-col6", order: 5, text: oResource.getText("PROGRES"), visible: true},
              {id: "Piani-tbPiani-col7", order: 6, text: oResource.getText("DESC_PROG"), visible: true},
              {id: "Piani-tbPiani-col10", order: 7, text: oResource.getText("DIVISIONE"), visible: true},
              {id: "Piani-tbPiani-col20", order: 8, text: oResource.getText("SEDE_TECNICA"), visible: true},
              {id: "Piani-tbPiani-col21", order: 9, text: oResource.getText("SEDE_TECNICA_P"), visible: true},
              {id: "Piani-tbPiani-col27", order: 10, text: oResource.getText("DESC_SEDE"), visible: true},
              ...
              {id: "Piani-tbPiani-col70", order: 64, text: oResource.getText("NUM"), visible: false},
              {id: "Piani-tbPiani-col71", order: 65, text: oResource.getText("LSTAR_1"), visible: false},
              {id: "Piani-tbPiani-col72", order: 65, text: oResource.getText("STEUS_1"), visible: false},
              {id: "Piani-tbPiani-col73", order: 73, text: oResource.getText("NUM_1"), visible: false},
              {id: "Piani-tbPiani-col74", order: 74, text: oResource.getText("LSTAR_2"), visible: false},
              {id: "Piani-tbPiani-col75", order: 75, text: oResource.getText("STEUS_2"), visible: false},
              {id: "Piani-tbPiani-col76", order: 76, text: oResource.getText("NUM_2"), visible: false},
              {id: "Piani-tbPiani-col77", order: 77, text: oResource.getText("LSTAR_3"), visible: false},
              {id: "Piani-tbPiani-col78", order: 78, text: oResource.getText("STEUS_3"), visible: false},
              {id: "Piani-tbPiani-col79", order: 79, text: oResource.getText("NUM_3"), visible: false},
              {id: "Piani-tbPiani-col80", order: 80, text: oResource.getText("LSTAR_4"), visible: false},
              {id: "Piani-tbPiani-col90", order: 90, text: oResource.getText("STEUS_4"), visible: false},
              {id: "Piani-tbPiani-col91", order: 91, text: oResource.getText("NUM_4"), visible: false},
              {id: "Piani-tbPiani-col92", order: 92, text: oResource.getText("LSTAR_5"), visible: false},
              {id: "Piani-tbPiani-col93", order: 93, text: oResource.getText("STEUS_5"), visible: false},
              {id: "Piani-tbPiani-col94", order: 94, text: oResource.getText("NUM_5"), visible: false},
