sap.ui.define([
  ...
  return Controller.extend("PM030.APP2.controller.DetailPage", {
    ...
    ProgressClose: function (oEvent) {
      ...
      var sProgr = this.lineSelected.PROGRES;
      if (sProgr) {
        this.createInvisibleMessage(this.getResourceBundle().getText("invDescProgrEnabled"));
      }
    },
    ...
    onSelStrategia: function (oEvent) {
      ...
      this.getView().getModel("sSelect").refresh();
      var sStreteg = sSelect.STRATEGIA_DESC;
      if (sStreteg) {
        this.createInvisibleMessage(this.getResourceBundle().getText("invDescStrategEnabled"));
      }
    },
